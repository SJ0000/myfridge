...
public class RecipeController {
    ...
    public ResponseEntity<SingleResponseDto<RecipeRecommendDto>> getRecentRecipes() {
    ...
    public ResponseEntity<SingleResponseDto<RecipeRecommendDto>> getPopularRecipes() {
